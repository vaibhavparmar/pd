...
<div class="container-fluid nav-hidden" id="content">
    ...
    <div id="main">
        ...
        <ul class="tiles">
        <li class="blue long">
            <a href="<?php echo site_url('mission/add_mission_load') ?>"><span><i class="icon-shopping-cart"></i></span><span class='name'>Add Mission</span>   
        </a>
        </li>


        <li class="orange long">
        <a href="<?php echo site_url('submission')?>"><span><i class="icon-cogs"></i></span><span class='name'>Add sub mission </span></a>
        </li>

        <li class="teal long">
        <a href="<?php echo site_url('mission/displayall') ?>"><span class='count'><i class="icon-search"></i></span><span class='name'>Manage Mission</span></a>
        </li>
